 ...
 School Location
           ...
           <script type="text/javascript">
            function init_map(){var myOptions = {zoom:19,center:new google.maps.LatLng(14.356540,121.056370),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById("gmap_canvas"), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(14.356540,121.056370)});infowindow = new google.maps.InfoWindow({content:"<b>San Pedro City Polytechnic College</b><br/> (formerly San Pedro Technological Institute), Crismor Ave, Elvinda, Laguna<br/>4023 Philippines" });google.maps.event.addListener(marker, "click", function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
</div>
            </div>
