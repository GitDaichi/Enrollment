      ...
      <div class="row invoice-info">
        <div class="col-sm-8 invoice-col"> 
          <address>
            ...
            Address : <?php echo htmlspecialchars($studres->HOME_ADD); ?><br> 
            Contact No.: <?php echo htmlspecialchars($studres->CONTACT_NO); ?><br>
          </address>
        </div>
...
<div class="row">
  <div class="col-xs-12 table-responsive">
    <table class="table table-striped">
      ...
      <tbody>
      <?php  
        $totunit = 0; // Initialize as a number
        if (isset($_SESSION['admingvCart'])){
            ...
            for ($i = 0; $i < $count_cart; $i++) {  
                ...
                foreach ($cur as $result) { 
                    ...
                    $totunit += floatval($result->UNIT); // Ensure addition is numeric
                }  
            }  
        } 
      ?>
...
?>
   <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <p class="lead">
            <?php
             $subtot = 0; // Initialize as a number
             $perunit = 119.1;
             $entrancefee = 500;
             $totsem = 0;

             $subtot = floatval($totunit) * floatval($perunit);
             $totsem = floatval($entrancefee) + $subtot;
          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tr>
                ...
                <td><input type="text" id="PartialPayment" autocomplete="false" name="PartialPayment" required="true"></td>
              </tr>
              <tr>
                <th>Balance:</th>
