...
<title><?php echo $title;?> | SPCPC</title>
   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img src="<?php echo web_root; ?>img/SPCPC.ico" height="23">
                Student and Enrollment Management System for SPCPC</a>
            </div>
            <!-- /.navbar-header -->
...
?> 
  ...
  <div id="page-wrapper">
    ...
    <!-- /#wrapper -->
      ...
      <!-- <footer><p align="Left">&copy; San Pedro City Polytechnic College</p></footer> -->
